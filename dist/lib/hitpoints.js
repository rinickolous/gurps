...
export default class HitFatPoints {
    ...
    _resolveCondition(type, value, attr) {
        if (type === 'HP')
            return this.hpCondition(value, attr);
        if (type === 'FP')
            return this.fpCondition(value, attr);
    ...
    _resolveBreakpoints(type, value, options) {
        if (type === 'HP')
            return this.getHpBreakpoints(value, options);
        if (type === 'FP')
            return this.getFpBreakpoints(value, options);
