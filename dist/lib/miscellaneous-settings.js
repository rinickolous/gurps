...
export function initializeSettings() {
    Hooks.once('init', async function () {
        ...
        game.settings.register(SYSTEM_NAME, SETTING_BODY_HITS, {
            ...
            hint: game.i18n.localize('From High Tech 162: Body Hits caps piercing, impaling, and tight-beam burning damage dealt to the torso at 2x max hp, and also adds a 1/6 chance of hitting vitals when targeting the torso.'),
            scope: 'world',
            config: true,
            type: Boolean,
            default: false,
        ...
        game.settings.register(SYSTEM_NAME, SETTING_MANEUVER_UPDATES_MOVE, {
            ...
            hint: game.i18n.localize('GURPS.settingHintManeuverMove', "Setting the maneuver (in combat) updates the actor's move value to the maximum allowed by the maneuver (e.g., none, step, half, etc.)."),
            scope: 'world',
            config: true,
            type: Boolean,
            default: true,
        ...
        game.settings.register(SYSTEM_NAME, SETTING_USE_ON_TARGET, {
            ...
            hint: game.i18n.localize('GURPS.settingHintOnTarget', 'Adds additional aiming-related maneuvers from the Pyramid #3/120 article On Target.'),
            scope: 'world',
            config: true,
            type: Boolean,
            default: false,
