            ...
            function (require, module, exports) {
                ...
                var _default = function _default(XRegExp) {
                    ...
                    /\\([pP])(?:{(\^?)(?:(\w+)=)?([^}]*)}|([A-Za-z]))/, function (match, scope, flags) {
                        ...
                        var _match = (0, _slicedToArray2['default'])(match, 6), fullToken = _match[0], pPrefix = _match[1], caretNegation = _match[2], typePrefix = _match[3], tokenName = _match[4], tokenSingleCharName = _match[5]; // Negated via \P{..} or \p{^..}
        ...
        8: [
            function (require, module, exports) {
                ...
                function copyRegex(regex, options) {
                    ...
                    regex = augment(new RegExp(options.source || regex.source, flags), hasNamedCapture(regex)
                        ? (0, _slice['default'])((_context2 = xData.captureNames)).call(_context2, 0)
                        : null, xregexpSource, xregexpFlags, options.isInternalOnly);
                    return regex;
                }
                /**
      ...
      */
        ...
        117: [
            function (require, module, exports) {
                ...
                var NEW_ITERATOR_PROTOTYPE = IteratorPrototype == undefined ||
                    fails(function () {
                        var test = {};
        ...
        185: [
            function (require, module, exports) {
                ...
                if ($stringify) {
                    var FORCED_JSON_STRINGIFY = !NATIVE_SYMBOL ||
                        fails(function () {
                            var symbol = $Symbol();
